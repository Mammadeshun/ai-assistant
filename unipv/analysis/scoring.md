...
Every figure below is counted from files under `unipv/raw/`, collected 2026-09-07. Blank means not measurable from what was collected — never an estimate dressed as a count.

12 CFU passed, 168 remaining of 180.
...
### 509521 · LABORATORY OF MACHINE LEARNING — 3 CFU — Tier A
...
- **Format, quoted from the course pages**:
  - *duration*: “21 hours remaining Last modified - Submission comments ___picture___”
  - *duration*: “22 ore Ultima modifica - Commenti alle consegne ___picture___ ___n”
...
- **Format, quoted from the course pages**:
  - *format*: “written exams , it is confirmed that they must be carried out in person to ensure their full regularity”
  - *format*: “written exams are held in presence , except for few exceptions related to the COVID-19, see the rules above”
  - *duration*: “duration of the test is 1 hour Pass Part 1 of the Calculus exam with a score of at least”
  - *duration*: “3 hours and is divided into two parts (with half time allowed for e”
  - *materials*: “closed books test : notes, books, calculators or similar instruments, items with a photocam”
  - *project*: “Progetto sulla didattica innovativa): students who are in one of the categories identified by "progetto sulla didattica innovativ”
...
- **Risk flags**: predictability not measurable · project component.
- **Format, quoted from the course pages**:
  - *project*: “Project GLOBE (Global Leadership and Organizational Behavior Effectiveness) has extended Hofstede�s assessment”
  - *project*: “project areas, whereas the international matrix typically highlights managers for both regional areas and product or project are”

### 509485 · COGNITIVE PSYCHOLOGY — 6 CFU — Tier B
...
- **Format, quoted from the course pages**:
  - *format*: “Written exam (25 points max): multiple choice questions (5 points) open questions (20 points) on book materials Students who have ob”
  - *format*: “written exam (can modulate the result of the written part) presentation/d iscussion of the research papers (6 points)”
...
- **Risk flags**: already booked, cannot cancel · project component.
- **Format, quoted from the course pages**:
  - *format*: “written exam Bloqueado CLAUDIA CASELLATO 30 de janeiro de 2024 CLAUDIA CASELLATO 30 de janeiro de 2024 0 Marcar este tópico com estr”
  - *format*: “written exam Locked CLAUDIA CASELLATO 30 Jan 2024 CLAUDIA CASELLATO 30 Jan 2024 0 Star this discussion pauses for lunch Locked CLAUD”
...
- **Format, quoted from the course pages**:
  - *duration*: “2 ore Messaggistica Contatti Messaggi selezionati: 1 &times; Cont”
  - *duration*: “2 hours Last modified - Submission comments ___picture___ ___name__”
...
- **⚠ NOT MEASURED - no papers and no questions were found for this course. The hours are a floor the model emits with no evidence, not an estimate, and the cost per pass is unusable.**
- **Risk flags**: no past papers · predictability not measurable · DATA INCOMPLETE - no material collected · project component.
- **Format, quoted from the course pages**:
  - *project*: “PROJECT WORK | Kiro Skip to main content 30 Notifications You have no notifications See all 0 There are 0 unread conversations Brick”
  - *project*: “Project work and thesis proposals Collapse Expand Project work and thesis proposals Select activity Proposals Proposals Database Top”
...
- **Format, quoted from the course pages**:
  - *format*: “Written Exam Bloqueado MARCO VIVIANI 7 de setembro de 2026 MARCO VIVIANI 7 de setembro de 2026 0 Marcar este tópico com estrela Publ”
  - *format*: “Written Exam &amp; Projects) Bloqueado MARCO VIVIANI 3 de agosto de 2026 MARCO VIVIANI 3 de agosto de 2026 0 Marcar este tópico com”
  - *project*: “Project instructions Project instructions File Seleziona sezione Internet and Web Technologies Minimizza Espandi Internet and We”
  - *project*: “Project Presentations Bloqueado MARCO VIVIANI 27 de julho de 2026 MARCO VIVIANI 27 de julho de 2026 0 Marcar este tópico com est”
